    ...
    private void updateWindow(boolean force, boolean redrawNeeded) {
        ...
        if (force || creating || formatChanged || sizeChanged || visibleChanged
            ...
            try {
                ...
                mLayout.format = isVideoHole ? PixelFormat.VIDEO_HOLE_REAL : (mOpaque ? PixelFormat.VIDEO_HOLE : mRequestedFormat);
                String pname = getContext().getPackageName();
                //Log.w(TAG,"package name is : "+pname);
                if(pname.equals("cn.livetv"))
                {
                	 mLayout.format = PixelFormat.RGBX_8888;
                }
