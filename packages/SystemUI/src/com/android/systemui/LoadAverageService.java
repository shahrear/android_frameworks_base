...
public class LoadAverageService extends Service {
    ...
    private class LoadView extends View {
        ...
        public void onDraw(Canvas canvas) {
			...
			/*
			if (check_energy_monitor) {
				avw = InfoUtils.GetAVW();
				if (avw == null) {
					Log.e("LoadAverageService", "Not availabled Energy Monitor");
					check_energy_monitor = false;
				}
			}
			*/
			...
			String str = "GPU : " + gpu + "MHz";
            //canvas.drawText(str, 0, y-1, mShadow3Paint);
            //canvas.drawText(str, 0, y+1, mShadow3Paint);
            canvas.drawText(str, 2, y-1, mShadow3Paint);
            canvas.drawText(str, 2, y+1, mShadow3Paint);
            canvas.drawText(str, 1, y, mInfoPaint);

			str = "CPU1 : " + clock[0] + "MHz, " + temp[0] + "°C, " + usage[0] + "%";
            //canvas.drawText(str, 0, y+mFH2-1, mShadow3Paint);
            //canvas.drawText(str, 0, y+mFH2+1, mShadow3Paint);
            canvas.drawText(str, 2, y+mFH2-1, mShadow3Paint);
            canvas.drawText(str, 2, y+mFH2+1, mShadow3Paint);
            canvas.drawText(str, 1, y+mFH2, mInfoPaint);

			str = "CPU2 : " + clock[1] + "MHz, " + temp[1] + "°C, " + usage[1] + "%";
			...
			str = "CPU3 : " + clock[2] + "MHz, " + temp[2] + "°C, " + usage[2] + "%";
            //canvas.drawText(str, 0, y+mFH2*3-1, mShadow3Paint);
            //canvas.drawText(str, 0, y+mFH2*3+1, mShadow3Paint);
            canvas.drawText(str, 2, y+mFH2*3+1, mShadow3Paint);
            canvas.drawText(str, 2, y+mFH2*3-1, mShadow3Paint);
            canvas.drawText(str, 1, y+mFH2*3, mInfoPaint);

			str = "CPU4 : " + clock[3] + "MHz, " + temp[3] + "°C, " + usage[3] + "%";
            //canvas.drawText(str, 0, y+mFH2*4-1, mShadow3Paint);
            //canvas.drawText(str, 0, y+mFH2*4+1, mShadow3Paint);
			...
			//canvas.drawText(str, 0, y+mFH2*5-1, mShadow3Paint);
			//canvas.drawText(str, 0, y+mFH2*5+1, mShadow3Paint);
			...
			/*
			if (avw != null) {
				str = "A15 Power : " + avw[0] + "V, " + avw[1] + "A, " + avw[2] + "W";
				canvas.drawText(str, 0, y+mFH2*6-1, mShadow3Paint);
				canvas.drawText(str, 0, y+mFH2*6+1, mShadow3Paint);
				canvas.drawText(str, 2, y+mFH2*6-1, mShadow3Paint);
				canvas.drawText(str, 2, y+mFH2*6+1, mShadow3Paint);
				canvas.drawText(str, 1, y+mFH2*6, mInfoPaint);

				str = "A7  Power : " + avw[3] + "V, " + avw[4] + "A, " + avw[5] + "W";
				canvas.drawText(str, 0, y+mFH2*7-1, mShadow3Paint);
				canvas.drawText(str, 0, y+mFH2*7+1, mShadow3Paint);
				canvas.drawText(str, 2, y+mFH2*7-1, mShadow3Paint);
				canvas.drawText(str, 2, y+mFH2*7+1, mShadow3Paint);
				canvas.drawText(str, 1, y+mFH2*7, mInfoPaint);

				str = "GPU Power : " + avw[6] + "V, " + avw[7] + "A, " + avw[8] + "W";
				canvas.drawText(str, 0, y+mFH2*8-1, mShadow3Paint);
				canvas.drawText(str, 0, y+mFH2*8+1, mShadow3Paint);
				canvas.drawText(str, 2, y+mFH2*8-1, mShadow3Paint);
				canvas.drawText(str, 2, y+mFH2*8+1, mShadow3Paint);
				canvas.drawText(str, 1, y+mFH2*8, mInfoPaint);

				str = "MEM Power : " + avw[9] + "V, " + avw[10] + "A, " + avw[11] + "W";
				canvas.drawText(str, 0, y+mFH2*9-1, mShadow3Paint);
				canvas.drawText(str, 0, y+mFH2*9+1, mShadow3Paint);
