...
public class NetworkController extends BroadcastReceiver implements DemoMode {
    ...
    // telephony
    static final int ACTION_USB_DEVICE_DETACHED = 1;
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equals(WifiManager.RSSI_CHANGED_ACTION)
            ...
            refreshViews();
        		...
        		Log.d(TAG, "action: ACTION_USB_DEVICE_DETACHED, sendMessageDelayed");
						Message msg = Message.obtain();
            msg.what = ACTION_USB_DEVICE_DETACHED;            
            mPhoneHandler.sendMessageDelayed(msg, 3*1000);
        	  updateConnectivity(intent);
            refreshViews();
        }
    }
